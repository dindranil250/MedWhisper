      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold">MedWhisper</span>
            </div>
            <p className="mt-4 text-gray-400">
              Revolutionizing healthcare documentation with AI-powered speech recognition technology.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li className="flex items-center">
                ...
                <a href="mailto:info@medwhisper.com" className="text-base text-gray-400 hover:text-white">info@medwhisper.com</a>
              </li>
              <li className="flex items-center">
                <Phone className="h-5 w-5 text-gray-400 mr-2" />
                <a href="tel:+1-800-123-4567" className="text-base text-gray-400 hover:text-white">+1-800-123-4567</a>
              </li>
              <li className="flex items-start">
                <MapPin className="h-5 w-5 text-gray-400 mr-2 mt-1" />
                <span className="text-base text-gray-400">123 Medical Drive<br />San Francisco, CA 94107</span>
              </li>
            </ul>
          </div>
        </div>
        <div className="mt-12 border-t border-gray-700 pt-8">
          <p className="text-base text-gray-400 text-center">
            &copy; {new Date().getFullYear()} MedWhisper. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
